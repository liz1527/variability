...
varysig, varydata = run_max_likely(varydata)
xvarysig, xvarydata = run_max_likely(xvarydata)
noxvarysig, noxvarydata = run_max_likely(noxvarydata)
#%% Plot result ###
...
plt.scatter(varyz, varyI1minI2, c=varysig[:,0], vmax=clim, marker='o', label='Variable')
...
plt.scatter(varyz[varyzlimsmask], varyI1minI2[varyzlimsmask], 
            c=varysig[varyzlimsmask,0], vmax=clim, marker='o')
plt.scatter(xvaryz[xvaryzlimsmask], xvaryI1minI2[xvaryzlimsmask], 
            c=xvarysig[xvaryzlimsmask,0], vmax=clim, marker='o')
plt.scatter(noxvaryz[noxvaryzlimsmask], noxvaryI1minI2[noxvaryzlimsmask], 
            c=noxvarysig[noxvaryzlimsmask,0], vmax=clim, marker='o')
...
plt.scatter(varyz[varyIlolimsmask], varyI1minI2[varyIlolimsmask], 
            c=varysig[varyIlolimsmask,0], vmax=clim, marker='o')
plt.scatter(noxvaryz[noxvaryIlolimsmask], noxvaryI1minI2[noxvaryIlolimsmask], 
            c=noxvarysig[noxvaryIlolimsmask,0], vmax=clim, marker='o')
...
plt.scatter(varyz[varyIuplimsmask], varyI1minI2[varyIuplimsmask], 
            c=varysig[varyIuplimsmask,0], vmax=clim, marker='o')
plt.scatter(noxvaryz[noxvaryIuplimsmask], noxvaryI1minI2[noxvaryIuplimsmask], 
            c=noxvarysig[noxvaryIuplimsmask,0], vmax=clim, marker='o')