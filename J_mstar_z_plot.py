...
varydata = fits.open('variable_tables/J_variables_chi40_noneg_DR11data_old.fits')[1].data
...
deviant = fits.open('variable_tables/J_variables_chi40_noneg_deviant_DR11data.fits')[1].data

### with x/nox split ###
noxvarydata = fits.open('variable_tables/J_variables_chi40_noneg_noXray_DR11data.fits')[1].data
xvarydata = fits.open('variable_tables/J_variables_chi40_noneg_Xray_DR11data.fits')[1].data
#noxvarydata = fits.open('variable_tables/J_variables_chi40_noneg_nochanXray_DR11data.fits')[1].data
#xvarydata = fits.open('variable_tables/J_variables_chi40_noneg_chanXray_DR11data.fits')[1].data
...
z, m, highz = prep_variables(dr11)
noxz, noxm, noxhighz = prep_variables(noxvarydata)
xz, xm, xhighz = prep_variables(xvarydata)
varyz, varym, varyhighz = prep_variables(varydata)
allxz, allxm, allxhighz = prep_variables(fullxray)
...
devz, devm, devhighz = prep_variables(deviant)
...
### Plot high z points as arrows ###
plt.errorbar(z[highz], m[highz], xerr=0.05, xlolims=True, fmt='.',markersize=1, color='tab:gray', alpha=0.2)
plt.errorbar(allxz[allxhighz], allxm[allxhighz], xerr=0.05, xlolims=True, fmt= 'ks',markersize=5)
plt.errorbar(xz[xhighz], xm[xhighz], xerr=0.05, xlolims=True, fmt= 'ro')
plt.errorbar(noxz[noxhighz], noxm[noxhighz],  xerr=0.05, xlolims=True, fmt='bo')
