...
### Normalise arrays ###
#fluxn = vari_funcs.normalise(flux)
#fluxchann = vari_funcs.normalise(fluxchan)
#sfluxn = vari_funcs.normalise(sflux)
#
#
...
avgfluxperob2 = np.mean(flux2, axis=1) #for UD
#flux = vari_funcs.normalise(flux)
