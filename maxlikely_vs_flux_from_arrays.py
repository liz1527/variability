...
sdata = fits.open('mag_flux_tables/stars_mag_flux_table_extra_clean_no06_DR11data.fits')[1].data
...
#plt.errorbar(udsflux, udsout[:,0], yerr=udsout[:,1], fmt='ko', zorder=1)
#plt.plot(flux, out[:,0], 'bo', zorder=2, label='Variable')
...
#plt.plot(udsflux, udsout[:,0], 'ko', zorder=1, label='Galaxy')
#plt.plot(sflux, sout[:,0], 'm*', zorder=3, mfc='None')
