...
#nosternvarydata = fits.open('variable_tables/K/no06_variables_chi30_2arcsec_DR11data_SpUDSdata_IRAC.fits')[1].data
...
#noxsternvarydata = fits.open('variable_tables/K/no06_variables_chi30_2arcsec_DR11data_SpUDSdata_IRAC_noXray_stern.fits')[1].data
#xsternvarydata = fits.open('variable_tables/K/no06_variables_chi30_2arcsec_DR11data_SpUDSdata_IRAC_Xray_stern.fits')[1].data
...
#plt.rc('font', **font)
#plt.plot(z, m, '.',markersize=1, color='tab:gray', alpha=0.2, label='Galaxy', rasterized=True)
#plt.plot(allsternz, allsternm, 'k.', label='Non-Variable Stern AGN', alpha=0.5, rasterized=True)
