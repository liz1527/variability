...
#    plt.close('all')
    ...
    plt.xticks(t, years)
    plt.tight_layout()
    plt.savefig('plots/Chi30Lightcurves/extra_clean_no06/flux/deviant/flux_'+str(n))#+str(varys['NUMBER_05B'][n])+'_lightcurve.png')
    plt.close('all')
#mask = mask.astype(bool)
#bad = newvarys[mask]
#badt = Table(bad)
#badt.write('variable_tables/bad07B.fits')