...
varydata = vari_funcs.field_funcs.chandra_only(varydata)
noxvarydata = vari_funcs.field_funcs.chandra_only(noxvarydata)
xvarydata = vari_funcs.field_funcs.chandra_only(xvarydata)
deviant = vari_funcs.field_funcs.chandra_only(deviant)
