...
xvarydata = Table.read('variable_tables/J_and_K_variables_month_varystats_DR11data_chan_xray.fits')#jdata[jdata['X-ray']==True]
noxvarydata = Table.read('variable_tables/J_and_K_variables_month_varystats_DR11data_chan_notxray.fits')#jdata[jdata['X-ray']==False]
...
plt.figure()
plt.hist([noxz, xz],  bins=50, color=['b','r'],histtype='step', 
...
#sigtb = Table.read('sigma_tables/K/quad_epoch_sigma_table_extra_clean_2arcsec_noneg.fits')
#
#xflux = vari_funcs.k_mag_flux.flux4_stacks(xvarydata)
#xflux, xfluxerr, xvarydata = vari_funcs.k_mag_flux.create_quad_error_array(sigtb, xvarydata, aper=4)
#
#noxflux = vari_funcs.k_mag_flux.flux4_stacks(noxvarydata)
#noxflux, noxfluxerr, noxvarydata = vari_funcs.k_mag_flux.create_quad_error_array(sigtb, noxvarydata, aper=4)
#
#xchi = vari_funcs.vary_stats.my_chisquare_err(xflux, xfluxerr)
#noxchi = vari_funcs.vary_stats.my_chisquare_err(noxflux, noxfluxerr)
#
